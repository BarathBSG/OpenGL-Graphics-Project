 ...
 */
bool CShader::CreateShaderProgram(string stName, const char* strVertexShaderFileName, const char* strFragmentShaderFileName)
{
	GLint uiError = 0;
 ...
 */
string CShader::LoadFileData(const char* stFileName)
{
 ...
 */
GLuint CShader::LoadShaderFromFile(const char* stFileName, GLenum uiEnumType)
{
	GLuint			uiShaderID = 0;
